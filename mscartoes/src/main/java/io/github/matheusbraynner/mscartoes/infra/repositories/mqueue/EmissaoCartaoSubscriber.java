package io.github.matheusbraynner.mscartoes.infra.repositories.mqueue;
...
import io.github.matheusbraynner.mscartoes.domain.DadosSolicitacaoEmissaoCartao;
...
public class EmissaoCartaoSubscriber {
    ...
    public void receberSolicitacaoEmissao(@Payload String payload) {
        try {
            ...
            log.error("Erro ao receer solicitacao de emissao de cartao: {}", e.getMessage());
        }
